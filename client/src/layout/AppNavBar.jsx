                ...
                <div className="container">
                    <div className="row justify-content-around">
                        <div className="col-md-6">
                            <span>
                                <span className="f-12">
                                    <i className="bi bi-envelope"></i> saedahmd0@gmail.com.com
                                </span>
                                <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01855894049
                                </span>
                            </span>
                        </div>
                        <div className="col-md-6">
                            <span className="float-end">
                                ...
                                </span>                                <span className="bodySmal mx-2">
                                    <i className="bi bi-youtube"></i>
                                </span>                                <span className="bodySmal">
